...
var XPrecise = {
    ...
    saveSettings: function () {
        ...
        var xprecise_settings = interface_toggle + delimiter + interface_position.top + delimiter + interface_position.left + delimiter + overlay_toggle + delimiter + jQuery("#xprecise-image").val() + delimiter + jQuery("#xprecise-top").val() + delimiter + jQuery("#xprecise-left").val() + delimiter + jQuery("#xprecise-opacity-value").text() + delimiter + jQuery("#xprecise-page-opacity-value").text() + delimiter + over_under;
    ...
    interfaceAppend: function () {
        ...
        jQuery('head').append('<link rel="stylesheet" type="text/css" media="all" href="http://3.s3.envato.com/files/240004/_xprecise/xprecise.css" />');
...
(function ($) {
    $.fn.ClearTypeFadeTo = function (options) {
        if (options) $(this).show().each(function () {
